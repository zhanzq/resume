...
\datedsubsection{\textbf{家电领域智能体agent开发}{\ (海尔优家)}}{2025年1月 -- 至今}

\role{\emph{Role:} 主要参与人员}{}
\begin{onehalfspacing}
\emph{项目简介}：基于LLM，开发家电领域智能体，以支持用户的复杂指令及个性化响应，提升用户的使用体验。
\\
\emph{成果}：
\begin{itemize}
  \item 实现一句话创建场景，如阅读场景、会客场景、观景场景等
  \item 实现对用户复杂指令的更友好支持，如“明天下雨的话，提醒我出门带伞”
  \item 结合用户数据，提供个性化服务，如“我的车今天限行吗”
\end{itemize}
\end{onehalfspacing}


\datedsubsection{\textbf{全领域大模型应用及落地}{\ (海尔优家)}}{2024年6月 -- 至今}

\role{\emph{Role:} 主要参与人员}{}
\begin{onehalfspacing}
\emph{项目简介}：基于开源的LLM，使用私有数据训练家电领域大模型，融合模型量化、KV缓存等技术，提升系统泛化能力的同时，保证系统响应的时效率，提升用户的使用体验。
\\
\emph{成果}：
\begin{itemize}
  \item 在冰、空、热、洗四大产业及其他产业全面实现大模型的应用
  \item 系统对长尾数据的泛化能力明显提升
  \item 在A10单卡上实现了70+吞吐量，生成速度达到20ms/token
\end{itemize}
\end{onehalfspacing}
...
\datedsubsection{\textbf{LLM研究与模型训练}{\ (海尔优家)}}{2023年1月 -- 2023年12月}
...
\begin{itemize}
  ...
  \item 对大模型的训练、微调及推理优化方法进行了较全面的研究学习，包括RLHF，ZeRO，FSDP，LoRA等优化技术，SparseAttention，Offload等训练技术和方法
...
\datedsubsection{\textbf{XP智能座仓新架构}{\ (北京小鹏汽车智能语音部)}}{2022年6月 -- 2023年1月}
\role{\emph{Role:} 主要参与人员}{}
\begin{onehalfspacing}
...
\datedsubsection{8. \textbf{基于大模型的交互系统更新方法、装置及存储介质 [发明]}}{申请号：CN202410225628.5}{公开日：2024.04.02}

\datedsubsection{9. \textbf{基于多模态融合的语义拒识方法及装置、存储介质 [发明]}}{申请号：CN202410863023.9}{公开日：2024.09.13}

\datedsubsection{10. \textbf{语义信息的确定方法、存储介质及电子装置 [发明]}}{申请号：CN202410682604.2}{申请日：2024.05.29}

\datedsubsection{11. \textbf{基于知识图谱的语义解析方法、装置、存储介质 [发明]}}{申请号：CN202411894802.1}{申请日：2024.12.20}

%\datedsubsection{12. \textbf{一种基于智能体的家电设备控制方法 [发明]}}{申请号：}{申请日：}
